...
<body>
  ...
  <div class="main p-3">
          ...
          <div class="modal-body" id="modAddBody">
            <form id="frmAddService">
              ...
              <div class="btn-group w-100">
                ...
                data-bs-toggle="dropdown" aria-expanded="false">Select Doctor</button>
    ...
    <form id="frmEditService">  
      <input type="hidden" id="eSelectedDoctorId" name="doctorId">    
        ...
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            ...
            <div class="modal-body" id="modEditBody">
              ...
              <!-- doctors dropdwon -->
              <div class="btn-group w-100">
                <button id="eSelectedDoctor" type="button" class="btn btn-primary dropdown-toggle text-start"
                data-bs-toggle="dropdown" aria-expanded="false">Select Doctor</button>
...
<script>
  $(document).ready(function () {
      ...
      $.ajax({
        ...
        success: function (response) {
          ...
          response.forEach(function (services) {
            ...
            <button id='btnEdit' type='button' class='btn btn-success' data-bs-toggle='modal' data-bs-target='#modEdit' data-service-id='${services.procedureId}' data-doctor-id='${services.doctorId}'>${services.procedureName}</button>
            <button id='btnDel' type='button' class='btn btn-danger' data-bs-toggle='modal' data-bs-target='#modDel' data-service-id='${services.procedureId}' data-doctor-id='${services.doctorId}'>${services.procedureName}</button>
            </div>
            </td>
            </tr>`;
    ...
    $(document).on('click', '#btnSave', function() {
      var procedureId = $('#btnEdit').data('service-id');
      var procedureName = $('#eProcedureName').val();
      var procedurePrice = $('#eProcedurePrice').val();
      var doctorId = $('#eSelectedDoctorId').val();
