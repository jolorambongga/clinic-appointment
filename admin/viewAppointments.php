      ...
      <ul class="sidebar-nav">
        ...
        <li class="sidebar-item">
          ...
          <ul id="auth" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
            <li class="sidebar-item">
              <a href="viewAppointments.php" class="sidebar-link sidebar-link-active">
    ...
    <div class="main p-3">
      ...
      <div class="container">
        <div class="table-container">
          ...
          <button class="btn btn-primary mb-3 float-end" type="sbumit" name="submit">New Appointment</button>
          <table class="table table-striped table-hover">
            <thead>
              <tr>
                <th scope="col">#</th>
                <th scope="col">Patient's Name</th>
                <th scope="col">Procedure To Do</th>
            ...
            <tbody>
              <tr>
                ...
                <td>The Street, TheDestionation Subdivision, Barangay, Municipality, City, Province</td>
                <td>
